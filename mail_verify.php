...
?>
  ...
  <body>
    <div class="login-box">
      <center>
        <h3 style="color:aliceblue;"><?php echo $_SESSION['success']; unset($_SESSION['success']);?></h3>
        <a href="./login.php" style=" text-decoration:none;"><div class="user-box" style="background: #03e9f4;
  color:green;
  border-radius: 5px;
  padding:10px;
