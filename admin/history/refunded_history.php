                    ...
                    <table id="example1" class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        try {
                          ...
                          // 3 - refunded
                          // 4 - recharged
                          $stmt = $conn->prepare("SELECT * FROM transaction WHERE day(transaction_date)=$day AND month(transaction_date)=$month AND year(transaction_date)=$year  AND transaction_type='3' ORDER BY transaction_id DESC");
                          $stmt->execute();
                          foreach ($stmt as $row) {
                            echo "<tr>";
                            echo "<td>" . $slno++ . "</td>";
