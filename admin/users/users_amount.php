...
$stmt->execute(['transaction_user_id'=>$id, 'transaction_send_to'=>'Added Manually', 'transaction_amount'=>$add_amount, 'transaction_method'=>'add amount', 'transaction_added_by'=>$by, 'transaction_type'=>0, 'transaction_date'=>$today]);
